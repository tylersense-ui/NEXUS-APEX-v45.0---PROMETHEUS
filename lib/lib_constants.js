 ...
 * ║                  "Stealing Efficiency From The Gods"                             ║
 * ╚══════════════════════════════════════════════════════════════════════════════════╝
 * 
 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════╣
 * ║ ✓ Documentation complète des unités (ms/s, GB/B)                                ║
 * ║ ✓ Constantes d'optimisation EV/s ajoutées                                       ║
 * ║ ✓ Cache TTL pour Network refresh                                                ║
 * ║ ✓ Timing buffers pour synchronisation précise                                   ║
 * ║ ✓ Instrumentation DEBUG_MODE améliorée                                          ║
 * ║ ✓ Configuration toasts optionnels                                               ║
 * ╚══════════════════════════════════════════════════════════════════════════════════╝
 * 
 * @usage
...
export async function main(ns) {
    ns.tprint("\x1b[38;5;196m╔══════════════════════════════════════════════════════════════════════════════════╗\x1b[0m");
    ns.tprint("\x1b[38;5;196m║                       NEXUS-APEX v45.0 - PROMETHEUS                              ║\x1b[0m");
    ns.tprint("\x1b[38;5;196m║                  \"Stealing Efficiency From The Gods\"                             ║\x1b[0m");
    ns.tprint("\x1b[38;5;196m╚══════════════════════════════════════════════════════════════════════════════════╝\x1b[0m");
    ns.tprint("");
    ns.tprint("\x1b[32m✅ Configuration PROMETHEUS chargée et validée.\x1b[0m");
    ...
    ns.tprint("");
    ns.tprint("\x1b[36mConfiguration système:\x1b[0m");
    ...
    ns.tprint(`  • NETWORK_CACHE_TTL: ${CONFIG.SYSTEM.NETWORK_CACHE_TTL_MS / 1000}s`);
