...
_createPrepBatch(target, prepStatus) {
    ...
    for (const job of jobs) {
        try {
            ...
            // ═══════════════════════════════════════════════════════════════
            // Ajouter un délai entre chaque dispatch pour éviter de saturer
            // le port 4. Cela donne au Controller le temps de lire.
            // 
            // Valeur recommandée : 20ms (permet ~50 jobs/seconde)
            // Si trop de WriteJSON échouent encore, augmenter à 30-50ms
            // ═══════════════════════════════════════════════════════════════
